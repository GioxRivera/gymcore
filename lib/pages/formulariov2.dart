...
class FormularioV2 extends StatelessWidget {
  @override
        ...
        children: [
          ...
          Positioned(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(gradient: config.linearBlackBottom),
              child: Column(
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton(
                          child: Text('Get Started', style: TextStyle(color: HexColor(config.fondoSecundario), fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'inter')),
                          onPressed: () {
                      ...
                      SizedBox(
                        ...
                        child: OutlinedButton(
                          child: Text('Log in', style: TextStyle(color: HexColor(config.fondoSecundario), fontSize: 16, fontWeight: FontWeight.w600, fontFamily: 'inter')),
                          onPressed: () {
                            showModalBottomSheet(
                              context: context,
                              backgroundColor: Colors.white,
                          ...
                          style: OutlinedButton.styleFrom(
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),
                            side: BorderSide(color: HexColor(config.fondoSecundario).withOpacity(0.5), width: 1),
